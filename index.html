...
<head>
    ...
    <title>Chalcecoin - Bitcoin And Crypto Currency HTML Template</title>
    <!-- Bootstrap core CSS -->
...
<body>
	...
	<div id="page-preloader">
		<div class="theme-loader">Chalcecoin</div>
	</div>
	<!-- END PRELOADER --> 
					...
					<div class="col-lg-4 col-md-12 col-sm-12 col-12">
						<div class="info-menu">
							<ul>
								...
								<li><a href="register.php"><i class="icofont icofont-user-alt-5"></i> Register </a></li> 
					...
					<div class="row">
						<div class="col-lg-9 d-none d-lg-block d-md-none">
							<nav class="navbar navbar-expand-lg justify-content-left">
								<ul class="navbar-nav">
								   <li class="dropdown"><a href="Chalcecoin.html" class="active nav-link">Home</a>
			...
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>why buy & sell</h5>
						<h3>Chalcecoin <span>Features</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->
        ...
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>Bitcoin Legality</h5>
						<h3>Why Choose <span>Chalcecoin</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->
        ...
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>what we do</h5>
						<h3>Chalcecoin <span>Services</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->	 
        ...
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>our masters</h5>
						<h3>Chalcecoin <span>Expert</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->	 
					...
					<div class="single-team-wrapper">
						<div class="single-team">
							...
							<div class="single-team-meta">
								<h4>Michael Sunday</h4>
								<span>Chalcecoin, CEO</span>
								<p>Lorem ipsum dolor sit amet consectetur ullamco adipiscing elit, sed do eiusmod tempor exercitat incididunt ut labore.</p>
							</div>	
						</div>							
					</div>
    ...
    <section id="pricetable" class="section-padding">
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>Chalcecoin conversation</h5>
						<h3>Trade Bitcoin <span>With Us</span></h3>
					</div>
				</div>
			<div data-aidaform-widget="form-2019-12" data-url="https://amazingwealth.aidaform.com/templates-en-email-signup-form" data-width="100%" data-height="500px" data-do-resize></div><script>(function(){var r,d=document,gt=d.getElementById,cr=d.createElement,tg=d.getElementsByTagName,id="aidaform-embed";if(!gt.call(d,id)){r=cr.call(d,"script");r.id=id;r.src="https://embed.aidaform.com/embed.js";(d.head || tg.call(d,"head")[0]).appendChild(r);}})()</script>
			<!-- end section title -->
			<div class="row">
